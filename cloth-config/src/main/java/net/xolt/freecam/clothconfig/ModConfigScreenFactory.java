...
public class ModConfigScreenFactory {
    ...
    private ConfigBuilder builder() {
        ConfigBuilder builder = ConfigBuilder.create()
                .setTitle(Component.translatable("kbfc.config.gui.title"))
    ...
    private static SubCategoryListEntry controlsCategory(ConfigEntryBuilder entryBuilder) {
        SubCategoryBuilder builder = entryBuilder.startSubCategory(Component.translatable("kbfc.config.controls.label"))
                .setTooltip(Component.translatable("kbfc.config.controls.tooltip"));
    ...
    private SubCategoryListEntry movementCategory(ConfigEntryBuilder entryBuilder) {
        SubCategoryBuilder builder = entryBuilder.startSubCategory(Component.translatable("kbfc.config.movement.label"))
                .setTooltip(Component.translatable("kbfc.config.movement.tooltip"));

        EnumListEntry<FlightMode> flightMode = entryBuilder.startEnumSelector(
                        Component.translatable("kbfc.config.movement.flightMode.label"),
                        FlightMode.class,
                        config().movement.flightMode)
                .setEnumNameProvider(value -> Component.translatable("kbfc.config.movement.flightMode." + value.name()))
                .setTooltip(Component.translatable("kbfc.config.movement.flightMode.tooltip"))
        ...
        LongSliderEntry horizontalSpeed = entryBuilder.startLongSlider(
                        Component.translatable("kbfc.config.movement.speed.horizontal.label"),
                ...
                .setTextGetter(value -> Component.translatable("kbfc.config.movement.speed.value", fromSlider(value)))
                .setTooltip(Component.translatable("kbfc.config.movement.speed.horizontal.tooltip"))
                .build();

        LongSliderEntry verticalSpeed = entryBuilder.startLongSlider(
                        Component.translatable("kbfc.config.movement.speed.vertical.label"),
                ...
                .setTextGetter(value -> Component.translatable("kbfc.config.movement.speed.value", fromSlider(value)))
                .setTooltip(Component.translatable("kbfc.config.movement.speed.vertical.tooltip"))
                .build();
    ...
    private SubCategoryListEntry collisionCategory(ConfigEntryBuilder entryBuilder) {
        SubCategoryBuilder builder = entryBuilder.startSubCategory(Component.translatable("kbfc.config.collision.label"))
                .setTooltip(Component.translatable("kbfc.config.collision.tooltip"));

        BooleanListEntry ignoreAll = entryBuilder.startBooleanToggle(
                        Component.translatable("kbfc.config.collision.ignoreAll.label"),
                        config().collision.ignoreAll)
                .setTooltip(
                        Component.translatable("kbfc.config.collision.ignoreAll.tooltip[0]"),
                        Component.translatable("kbfc.config.collision.ignoreAll.tooltip[1]")
                )
        ...
        BooleanListEntry ignoreTransparent = entryBuilder.startBooleanToggle(
                        Component.translatable("kbfc.config.collision.ignoreTransparent.label"),
                        config().collision.ignoreTransparent)
                //? if cloth_dependencies
                .setRequirement(() -> !ignoreAll.getValue())
                .setTooltip(Component.translatable("kbfc.config.collision.ignoreTransparent.tooltip"))
        ...
        BooleanListEntry ignoreOpenable = entryBuilder.startBooleanToggle(
                        Component.translatable("kbfc.config.collision.ignoreOpenable.label"),
                        config().collision.ignoreOpenable)
                //? if cloth_dependencies
                .setRequirement(() -> !ignoreAll.getValue())
                .setTooltip(Component.translatable("kbfc.config.collision.ignoreOpenable.tooltip"))
        ...
        BooleanListEntry ignoreCustom = entryBuilder.startBooleanToggle(
                        Component.translatable("kbfc.config.collision.ignoreCustom.label"),
                        config().collision.ignoreCustom)
                //? if cloth_dependencies
                .setRequirement(() -> !ignoreAll.getValue())
                .setTooltip(Component.translatable("kbfc.config.collision.ignoreCustom.tooltip"))
        ...
        StringListListEntry idWhitelist = entryBuilder.startStrList(
                        Component.translatable("kbfc.config.collision.whitelist.ids.label"),
                        config().collision.whitelist.ids)
                .setTooltip(
                        Component.translatable("kbfc.config.collision.whitelist.ids.tooltip[0]"),
                        Component.translatable("kbfc.config.collision.whitelist.ids.tooltip[1]"))
                //? if cloth_dependencies
        ...
        StringListListEntry patternWhitelist = entryBuilder.startStrList(
                        Component.translatable("kbfc.config.collision.whitelist.patterns.label"),
                        config().collision.whitelist.patterns)
                .setTooltip(
                        Component.translatable("kbfc.config.collision.whitelist.patterns.tooltip[0]"),
                        Component.translatable("kbfc.config.collision.whitelist.patterns.tooltip[1]"))
                //? if cloth_dependencies
                .setDisplayRequirement(ignoreCustom::getValue)
        ...
        BooleanListEntry alwaysCheck = entryBuilder.startBooleanToggle(
                        Component.translatable("kbfc.config.collision.alwaysCheck.label"),
                        config().collision.alwaysCheck)
                .setTooltip(
                        Component.translatable("kbfc.config.collision.alwaysCheck.tooltip[0]"),
                        Component.translatable("kbfc.config.collision.alwaysCheck.tooltip[1]"))
    ...
    private SubCategoryListEntry visualCategory(ConfigEntryBuilder entryBuilder) {
        SubCategoryBuilder builder = entryBuilder.startSubCategory(Component.translatable("kbfc.config.visual.label"))
                .setTooltip(Component.translatable("kbfc.config.visual.tooltip"));

        EnumListEntry<Perspective> perspective = entryBuilder.startEnumSelector(
                        Component.translatable("kbfc.config.visual.perspective.label"),
                        Perspective.class,
                        config().visual.perspective)
                .setEnumNameProvider(value -> Component.translatable("kbfc.config.visual.perspective." + value.name()))
                .setTooltip(Component.translatable("kbfc.config.visual.perspective.tooltip"))
        ...
        BooleanListEntry showPlayer = entryBuilder.startBooleanToggle(
                        Component.translatable("kbfc.config.visual.showPlayer.label"),
                        config().visual.showPlayer)
                .setTooltip(Component.translatable("kbfc.config.visual.showPlayer.tooltip"))
        ...
        BooleanListEntry outlinePlayer = entryBuilder.startBooleanToggle(
                Component.translatable("kbfc.config.visual.outlinePlayer.label"),
                config().visual.outlinePlayer)
            .setTooltip(
                Component.translatable("kbfc.config.visual.outlinePlayer.tooltip[0]"),
                Component.translatable("kbfc.config.visual.outlinePlayer.tooltip[1]")
            )
        ...
        BooleanListEntry showHand = entryBuilder.startBooleanToggle(
                        Component.translatable("kbfc.config.visual.showHand.label"),
                        config().visual.showHand)
                .setTooltip(Component.translatable("kbfc.config.visual.showHand.tooltip"))
        ...
        BooleanListEntry fullBright = entryBuilder.startBooleanToggle(
                        Component.translatable("kbfc.config.visual.fullBright.label"),
                        config().visual.fullBright)
                .setTooltip(Component.translatable("kbfc.config.visual.fullBright.tooltip"))
        ...
        BooleanListEntry showSubmersion = entryBuilder.startBooleanToggle(
                        Component.translatable("kbfc.config.visual.showSubmersionFog.label"),
                        config().visual.showSubmersion)
                .setTooltip(Component.translatable("kbfc.config.visual.showSubmersionFog.tooltip"))
    ...
    private SubCategoryListEntry utilityCategory(ConfigEntryBuilder entryBuilder) {
        SubCategoryBuilder builder = entryBuilder.startSubCategory(Component.translatable("kbfc.config.utility.label"))
                .setTooltip(Component.translatable("kbfc.config.utility.tooltip"));

        BooleanListEntry disableOnDamage = entryBuilder.startBooleanToggle(
                        Component.translatable("kbfc.config.utility.disableOnDamage.label"),
                        config().utility.disableOnDamage)
                .setTooltip(Component.translatable("kbfc.config.utility.disableOnDamage.tooltip"))
        ...
        BooleanListEntry freezePlayer = entryBuilder.startBooleanToggle(
                        Component.translatable("kbfc.config.utility.freezePlayer.label"),
                        config().utility.freezePlayer)
                .setTooltip(
                        Component.translatable("kbfc.config.utility.freezePlayer.tooltip[0]"),
                        Component.translatable("kbfc.config.utility.freezePlayer.tooltip[1]")
                )
        ...
        BooleanListEntry allowInteract = entryBuilder.startBooleanToggle(
                        Component.translatable("kbfc.config.utility.interact.allow.label"),
                        config().utility.allowInteract)
                .setTooltip(
                        Component.translatable("kbfc.config.utility.interact.allow.tooltip[0]"),
                        Component.translatable("kbfc.config.utility.interact.allow.tooltip[1]")
                )
        ...
        EnumListEntry<ModConfigDTO.InteractionMode> interactionMode = entryBuilder.startEnumSelector(
                        Component.translatable("kbfc.config.utility.interact.mode.label"),
                        ModConfigDTO.InteractionMode.class,
                        config().utility.interactionMode)
                .setEnumNameProvider(value -> Component.translatable("kbfc.config.utility.interact.mode." + value.name()))
                .setTooltip(Component.translatable("kbfc.config.utility.interact.mode.tooltip"))
    ...
    private SubCategoryListEntry serversCategory(ConfigEntryBuilder entryBuilder) {
        SubCategoryBuilder builder = entryBuilder.startSubCategory(Component.translatable("kbfc.config.servers.label"))
                .setTooltip(Component.translatable("kbfc.config.servers.tooltip"));

        EnumListEntry<ModConfigDTO.ServerRestriction> mode = entryBuilder.startEnumSelector(
                        Component.translatable("kbfc.config.servers.mode.label"),
                        ModConfigDTO.ServerRestriction.class,
                        config().servers.mode)
                .setEnumNameProvider(value -> Component.translatable("kbfc.config.servers.mode." + value.name()))
                .setTooltip(
                        Component.translatable("kbfc.config.servers.mode.tooltip[0]"),
                        Component.translatable("kbfc.config.servers.mode.tooltip[1]"))
        ...
        StringListListEntry whitelist = entryBuilder.startStrList(
                        Component.translatable("kbfc.config.servers.whitelist.label"),
        ...
        StringListListEntry blacklist = entryBuilder.startStrList(
                        Component.translatable("kbfc.config.servers.blacklist.label"),
    ...
    private SubCategoryListEntry notificationCategory(ConfigEntryBuilder entryBuilder) {
        SubCategoryBuilder builder = entryBuilder.startSubCategory(Component.translatable("kbfc.config.notification.label"))
                .setTooltip(Component.translatable("kbfc.config.notification.tooltip"));

        BooleanListEntry notifyFreecam = entryBuilder.startBooleanToggle(
                        Component.translatable("kbfc.config.notification.freecam.label"),
                        config().notification.notifyFreecam)
                .setTooltip(Component.translatable("kbfc.config.notification.freecam.tooltip"))
        ...
        BooleanListEntry notifyTripod = entryBuilder.startBooleanToggle(
                        Component.translatable("kbfc.config.notification.tripod.label"),
                        config().notification.notifyTripod)
                .setTooltip(Component.translatable("kbfc.config.notification.tripod.tooltip"))
